#!/usr/bin/env python3
"""Apply wingate/supabase/APPLY_ON_NEON.sql to DATABASE_URL_UNPOOLED (or DATABASE_URL)."""
...
def main() -> int:
    ...
    if not url:
        print("Set DATABASE_URL_UNPOOLED in wingate/.env.local", file=sys.stderr)
        return 1
    sql_path = ROOT / "supabase" / "APPLY_ON_NEON.sql"
