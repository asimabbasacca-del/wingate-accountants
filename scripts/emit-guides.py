#!/usr/bin/env python3
"""Emit original Wingate Accountants guides. Topics only — no third-party copy."""
...
def add(guide: dict) -> None:
    GUIDES.append(guide)


def s(heading: str, paragraphs: list[str], bullets: list[str] | None = None) -> dict:
    out = {"heading": heading, "paragraphs": paragraphs}
    if bullets:
        out["bullets"] = bullets
    return out
...
add(
    {
        ...
        "relatedSlugs": [
            ...
            "self-assessment-accountant-fees-2026",
        ],
        "sections": [
            s(
        ...
        "faqs": [
            faq(
                ...
                "No. Sole traders and partners pay Income Tax and National Insurance on profits. Corporation Tax applies to limited companies. If you are unsure which you are, start with our guide to [sole trader versus limited company](/blog/sole-trader-or-limited-company).",
            ),
            faq(
            ...
            faq(
                "Can Wingate prepare the return from my records?",
...
add(
    {
        ...
        "faqs": [
            ...
            faq(
                ...
                "Status can still be challenged. A disclosure and a clean payroll from a set date is usually better than waiting for a review. Wingate can map the risk with you.",
            ),
        ],
    }
)
...
add(
    {
        ...
        "relatedSlugs": [
            "self-assessment-tax-return-guide",
            "uk-tax-rates-thresholds-allowances-self-employed-2026",
...
add(
    {
        ...
        "faqs": [
            ...
            faq(
                ...
                "No. Many sellers start as sole traders. A company can make sense later for liability, finance or tax planning — see [sole trader or limited company](/blog/sole-trader-or-limited-company).",
            ),
        ],
    }
)
...
add(
    {
        ...
        "faqs": [
            ...
            faq(
                ...
                "That is compulsory registration with a backdated date, not a voluntary choice. See [what happens if you exceed the VAT threshold](/blog/vat-registration-threshold).",
            ),
        ],
    }
)
...
add(
    {
        ...
        "read": "8 min read",
        "relatedSlugs": [
            "register-as-partner-in-a-partnership",
            "llp-versus-limited-company",
            "self-assessment-tax-return-guide",
        ],
        "sections": [
            s(
...
add(
    {
        ...
        "relatedSlugs": [
            "hire-your-first-employee",
            "contractors-pension-contributions-subcontractors",
...
add(
    {
        ...
        "faqs": [
            faq(
                "Is Self Assessment free if I file it myself?",
                "HMRC does not charge a filing fee for a normal online return. You still pay the tax. Software and accountant fees are optional costs for accuracy and time.",
            ),
            faq(
                "Why do some firms charge extra after January?",
                "Late information compresses the work into penalty season. Many firms price that risk. Filing on time with complete records is the way to keep the fee at the quote.",
            ),
            faq(
                "Do you charge per client of another firm?",
                "No. Wingate is a practice serving its own clients. We quote the person or company in front of us.",
            ),
        ],
    }
)
...
add(
    {
        ...
        "sections": [
            s(
                "Register yourself, then link to the firm",
                [
            ...
            s(
                "LLPs are a different registration",
                [
        ...
        "faqs": [
            faq(
                "How long does a partner UTR take?",
                "HMRC posting times vary. Apply as soon as you join so you are not waiting in January. You can often file once the UTR is on the account.",
            ),
            faq(
                "Do I need a new National Insurance number?",
                "No. You use your existing number. Partners pay National Insurance through Self Assessment classes, not through a new card.",
            ),
            faq(
                "Can I be a partner and an employee of the same firm?",
                "In a general partnership you are not usually an employee of that partnership. Different group structures exist; they need a specific analysis.",
            ),
        ],
    }
)
...
add(
    {
        ...
        "faqs": [
            faq(
                "Can I skip a month if I paid nobody?",
                "Often you must still file a nil return while the scheme is active. Check your HMRC account rather than assuming silence is fine.",
            ),
            faq(
                "Does CIS replace Self Assessment for the subcontractor?",
                "No. Tax deducted at source is a credit. The subcontractor still reports profit and claims the credit on their return or in the company.",
            ),
            faq(
                "How do I get gross payment status?",
                "HMRC has turnover, compliance and business tests. Failed returns and unpaid tax are the usual blockers. We can review whether you are close before you apply.",
            ),
        ],
    }
)
...
add(
    {
        ...
        "sections": [
            s(
                "Sole trader: simpler, personally on the hook",
                [
            ...
            s(
                "Limited company: extra law, limited liability",
                [
        ...
        "faqs": [
            faq(
                ...
                "Yes. You can transfer the trade into a company. There are tax and VAT issues on the transfer, including possible capital gains and VAT on assets. Plan the date.",
            ),
            faq(
                "Does a company look more professional?",
                "Sometimes. Customers and lenders do notice ‘Ltd’. That is not a reason to ignore the filing burden or a personal guarantee sitting in the pack.",
            ),
            faq(
                "Is an LLP the middle option?",
                "It can be for professional firms. See [LLP versus limited company](/blog/llp-versus-limited-company).",
            ),
        ],
    }
)
...
add(
    {
        ...
        "sections": [
            s(
                "Register as an employer, then run payroll",
                [
            ...
            s(
                "Pensions, insurance and Right to Work",
                [
        ...
        "faqs": [
            faq(
                "Can my first hire be a contractor instead?",
                "Only if they are genuinely self-employed. Mislabeling an employee as a contractor stores up PAYE, pensions and holiday claims. Status has to match the facts.",
            ),
            faq(
                "Do I need a workplace pension for one part-time person?",
                "Possibly, if they meet the age and earnings tests. There is no ‘tiny firm’ exemption from auto-enrolment once you employ eligible jobholders.",
            ),
            faq(
                "What is an Employer Reference Number?",
                "People usually mean the PAYE reference. You will also see an Accounts Office reference for paying HMRC. Keep both on the payroll file.",
            ),
        ],
    }
)
...
add(
    {
        ...
        "sections": [
            s(
                "Same street address, different statute",
                [
        ...
        "faqs": [
            faq(
                ...
                "Generally no for a trading UK LLP — members pay Income Tax on their shares. There are exceptions and anti-avoidance rules. Do not assume ‘never’ without a review.",
            ),
            faq(
                "Is an LLP more private?",
                "LLPs still file accounts at Companies House. Privacy is not the reason to choose one.",
            ),
            faq(
                "Can I convert a company to an LLP?",
                "It is a reconstruction, not a form toggle. Tax, stamp and VAT issues arise. Plan it with an accountant and a solicitor.",
            ),
        ],
    }
)
...
add(
    {
        ...
        "relatedSlugs": [
            "self-assessment-tax-return-guide",
            "selling-on-amazon-uk-tax",
            "tax-for-actors-and-performers",
        ],
        "sections": [
            s(
                "Unprompted is a technical word",
                [
        ...
        "faqs": [
            faq(
                "Will I go to prison if I disclose?",
                "A full unprompted disclosure of careless or even some deliberate errors is usually a civil matter with tax, interest and penalties. Criminal investigation is a different path. Get advice if you are unsure which facts you have.",
            ),
            faq(
                "Can I just amend last year’s return?",
                "In-date amendments are fine for recent years. Older years, multiple years, or suspected fraud need a disclosure process, not a quiet tweak.",
            ),
            faq(
                "Should I ignore a ‘nudge’ letter?",
                "No. A nudge is often the start of prompted treatment. Reply with advice, not with silence.",
            ),
        ],
    }
)
...
add(
    {
        ...
        "faqs": [
            faq(
                "What if I cannot pay on 31 January?",
                "File on time anyway — late filing and late payment are different penalties. Then speak to HMRC about Time to Pay, ideally with a computation in hand.",
            ),
            faq(
                "Can I file without a UTR?",
                "You need a Unique Taxpayer Reference to file. Register as soon as you know you need a return. Do not wait for January.",
            ),
            faq(
                "Does Making Tax Digital replace Self Assessment?",
                "Making Tax Digital for Income Tax adds digital records and updates for qualifying sole traders and landlords. It does not mean you ignore the annual return. Confirm the latest timetable on GOV.UK.",
            ),
        ],
    }
)
...
def emit_guide(guide: dict) -> str:
    ...
    for key in (
        ...
        lines.append(f"    {key}: {ts_string(guide[key])},")
    if guide.get("featured"):
        lines.append("    featured: true,")
    slugs = ", ".join(ts_string(s) for s in guide["relatedSlugs"])
    lines.append(f"    relatedSlugs: [{slugs}],")
    lines.append("    sections: [")
    for section in guide["sections"]:
        lines.append("      {")
        lines.append(f"        heading: {ts_string(section['heading'])},")
        paras = ",\n          ".join(ts_string(p) for p in section["paragraphs"])
        lines.append(f"        paragraphs: [\n          {paras},\n        ],")
        if section.get("bullets"):
            bullets = ",\n          ".join(ts_string(b) for b in section["bullets"])
    ...
    for item in guide["faqs"]:
        lines.append("      {")
        lines.append(f"        question: {ts_string(item['question'])},")
        lines.append(f"        answer: {ts_string(item['answer'])},")
        lines.append("      },")
    lines.append("    ],")
    lines.append("  }")
    return "\n".join(lines)
...
def main() -> None:
    ...
    out = Path(__file__).resolve().parents[1] / "lib" / "guides.ts"
    body = ",\n".join(emit_guide(g) for g in GUIDES)
    text = (
